                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('home') }}" class="text-gray-500 hover:text-gray-700">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m0 0v14z"/>
                        </svg>
                        Back to Site
                    </a>
                </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="text-center">
                            <a href="{{ route('admin.posts.index') }}" class="inline-flex flex-col items-center p-6 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors duration-200">
                        ...
                        <!-- Manage Categories -->
                        <div class="text-center">
                            <a href="{{ route('admin.categories.index') }}" class="inline-flex flex-col items-center p-6 bg-green-50 rounded-lg hover:bg-green-100 transition-colors duration-200">
                        ...
                        <!-- Manage Tags -->
                        <div class="text-center">
                            <a href="{{ route('admin.tags.index') }}" class="inline-flex flex-col items-center p-6 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors duration-200">

...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="text-center mb-12">
        <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">News Sections</h1>
    ...
    @else
        <div class="text-center py-16">
            ...
            <h3 class="mt-2 text-lg font-medium text-gray-900 dark:text-white">No categories available</h3>
            <p class="mt-1 text-base text-gray-500 dark:text-gray-400">Check back later as we add more content sections.</p>
            <div class="mt-6">

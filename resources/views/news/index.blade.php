    ...
    <div class="relative bg-gray-50 pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
        <div class="relative max-w-7xl mx-auto">
            <div class="text-center">
                <h1 class="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl">Latest News</h1>
            ...
            <div class="mt-8">
                <div class="flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('home', ['tag' => $tag->slug]) }}" 
                       class="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium {{ request('tag') === $tag->slug ? 'bg-indigo-600 text-white' : 'bg-indigo-100 text-indigo-800' }}">
                        {{ $tag->name }}
